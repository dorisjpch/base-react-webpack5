...
A simple repository for creating react applications bundled by webpack 5, using using latest version of react and other technologies.
...
- docker build -t base-react-app .
- docker run -p 3000:3000 --rm -it base-react-app
